...
2. **Identity and version metadata:** **Phase 2A complete:** threat model, account/configuration contracts, Windows DPAPI vault abstraction, disabled non-Windows fallback, and validated/cached Mojang manifest browsing. **Phase 2B:** repository-owner public-client registration, real Microsoft OAuth, Xbox/Minecraft entitlement/profile calls, refresh, sign-out and revocation integration tests. No game launch until authentication tests and threat review pass.
